...
export type SkillTagVariant = 'cyan' | 'purple' | 'emerald' | 'gray' | 'outline' | 'default';
...
const variantStyles: Record<SkillTagVariant, string> = {
  ...
  purple: 'bg-purple-50 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300 border border-purple-100 dark:border-purple-800/50',
  emerald: 'bg-emerald-50 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300 border border-emerald-100 dark:border-emerald-800/50',
  ...
  default: 'bg-cyan-50 text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-300 border border-cyan-100 dark:border-cyan-800/50',
};
