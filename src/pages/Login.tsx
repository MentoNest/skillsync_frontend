...
const Login = () => {
  ...
  return (
      ...
      <div>
        ...
        <div className=" md:fixed inset-0 flex flex-col md:flex-row justify-center items-center gap-15 p-10">
          <div className="mb-5">
          ...
          <div>
            <img src={image1} alt="" className="hidden  md:block w-[25rem] h-[32rem] mb-[2rem] " />
          </div>
       </div>
