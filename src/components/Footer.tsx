    ...
    <footer className="mt-32 border-t border-gray-200 py-8">
       ...
       <div className="text-gray-600 text-sm flex flex-col gap-4 ">
            <div className="flex gap-3 flex-col">
                ...
                <p>© Copyright 2022 Bluepreent -
                Mentors for Mentees</p>
            </div>
            <div className="flex gap-1 flex-col">
                ...
                <ul className="flex flex-col gap-1 text-[#969696]">
                    ...
                    <li><a className="hover:text-gray-500" href='/ '>Become a mentor </a>  </li>
                    <li><a className="hover:text-gray-500" href='/ '>Contact</a>  </li>
                    <li><a className="hover:text-gray-500" href='/ '>Find a mentor</a>  </li>
                    <li><a className="hover:text-gray-500" href='/ '>Help</a>  </li>
...
<a href="" className="text-gray-800 hover:text-gray-600">+234 8029 290 1100</a>              
</div>

<div className="flex flex-col ">
<h3 className="text-sm text-gray-600 ">Email</h3>
<a href="" className="text-[#0E78B9]">support@bluepreent.com</a>              
</div>
...
<p className="text-gray-800">Gabriel House, Victoria Island
1102, NG</p>              
</div>
