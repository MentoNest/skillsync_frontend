export default function Testimonials() {
  ...
  return (
    <section aria-label="Testimonials" className="max-w-7xl mx-auto px-6 py-16">
      <style>{`
        .testimonials-grid { display: grid; gap: 1.25rem; }
        @media (min-width: 768px) { .testimonials-grid { grid-template-columns: repeat(3, 1fr); } }
        .card { background: white; border: 1px solid #eef2f7; border-radius: 12px; padding: 1.25rem; box-shadow: 0 6px 18px rgba(15,23,42,0.03); }
        .quote { color: #374151; line-height: 1.5; font-size: 0.95rem; }
        .avatar { width:48px; height:48px; border-radius:9999px; display:inline-flex; align-items:center; justify-content:center; background:#f3f4f6; color:#111827; font-weight:700; }
        .meta { margin-top: 0.9rem; display:flex; gap:0.75rem; align-items:center; }
        .name { font-weight:700; color:#111827; }
        .role { color:#6b7280; font-size:0.9rem; }
        .stars { color:#f59e0b; margin-bottom: 0.5rem; }
      `}</style>

      <h2 style={{ fontSize: 28, fontWeight: 800, color: '#0f172a', textAlign: 'center', marginBottom: 20 }}>What users are saying</h2>
