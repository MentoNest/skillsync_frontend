...
export default function DiscussionDetailsPage() {
  ...
  const handleToggleLock = () => {
    setDiscussion(prev => prev ? { ...prev, isLocked: !prev.isLocked } : null);
  };
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        {isLocked ? (
          ...
          >
            ...
            <p className="text-sm font-medium">This discussion is locked. No new replies can be added.</p>
          </div>
        ) : (
          <div className="mb-6">
            <textarea
        ...
        {discussion.comments.length === 0 && (
          <div className="text-center py-8 text-gray-500">
            <p>No comments yet. {!isLocked && 'Be the first to share your thoughts!'}</p>
          </div>
        )}
      </div>
    </div>
